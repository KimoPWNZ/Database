...
Проект представляет собой создание, наполнение и манипуляцию данными в СУБД PostgreSQL.
Целью проекта является закрепление полученных знаний в курсе "Базы данных".

Проект представляет 4 различные базы данных:
...
2. Создадим таблицы, запустив скрипт из файла /vehicles/create_table.sql
3. Наполним таблицы данными с помощью скрипта /vehicles/insert_data.sql
...
### Подготовительный этап:
1. Создадим БД car_racing в графическом интерфейсе.
2. Создадим таблицы, запустив скрипт из файла /car_racing/create_table.sql
3. Наполним таблицы данными с помощью скрипта /car_racing/insert_data.sql
...
Решение:
размещено в скрипте /car_racing/task1.sql
...
Решение:
размещено в скрипте /car_racing/task2.sql
...
Решение:
размещено в скрипте /car_racing/task3.sql
...
Решение:
размещено в скрипте /car_racing/task4.sql
...
Решение:
размещено в скрипте /car_racing/task5.sql
...
### Подготовительный этап:
1. Создадим БД hotel_booking в графическом интерфейсе.
2. Создадим таблицы, запустив скрипт из файла /hotel_booking/create_table.sql
3. Наполним таблицы данными с помощью скрипта /hotel_booking/insert_data.sql
...
Решение:
размещено в скрипте /hotel_booking/task1.sql
...
Решение:
размещено в скрипте /hotel_booking/task2.sql
...
2. Создадим таблицы, запустив скрипт из файла /organization_structure/create_table.sql
3. Наполним таблицы данными с помощью скрипта /organization_structure/insert_data.sql
...
Решение:
размещено в скрипте /organization_structure/task1.sql
...
Решение:
размещено в скрипте /organization_structure/task2.sql
...
Решение:
размещено в скрипте /organization_structure/task3.sql
